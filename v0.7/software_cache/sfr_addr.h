...
#define _OFFSET_CMD_COUNT_	                (0x020)
#define _OFFSET_DONE_	                    (0x014)
...
#define _OFFSET_R_CMD_SIZE_                 (0x03C)
#define _OFFSET_LBA_ADDR_                 (0x040)
...
#define _OFFSET_NAND_COMPLETE_              (0x10)

//////// Device interface
#define _ADDR_DEV_IF_BASE_					(0xe0000000) //changed to subreqman
...
#define _OFFSET_WRITE_COUNT_            (0x1C)
